                ...
                ?>
                 <div class="col-lg-4 col-md-6 my-3">
                      <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                        <img src="images/rooms/<?php echo $row['img']; ?>" class="card-img-top">
                          <div class="card-body">
                            ...
                            <div class="d-flex justify-content-evenly mb-2">
                              <a href="booking.php" class="btn btn-sm text-white coustem-bg shadow-none">Book Now</a>
              ...
              while($row = mysqli_fetch_assoc($query_run))
              {
                ?>
                 <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                  <img src="images/features/<?php echo $row['img']; ?>" width="80px">
          ...
          if($check_room)
          {
              while($row = mysqli_fetch_assoc($query_run))
              {
                ...
                <div class="profile d-flex align-items-center mb-3">
                  <img src="images/review/<?php echo $row['img']; ?>" width="30px" style="border-radius: 50px;">
                  <h6 class="m-0 ms-2"><?php echo $row['name']; ?></h6>
                </div>
                <p>
                  <?php echo $row['review']; ?>
                </p>
